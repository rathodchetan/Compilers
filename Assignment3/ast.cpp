...
seq_astnode::seq_astnode(vector<statement_astnode*> c1,string rcode){
        this->child1 = c1;
        this->rcode = rcode;
}
...
assignS_astnode::assignS_astnode(exp_astnode *c1,exp_astnode *c2,string rcode){
    this->child1 = c1;
    this->child2 = c2;
    this->rcode = rcode;
...
return_expnode::return_expnode(exp_astnode *c1,string rcode){
    this->child1 = c1;
    this->rcode = rcode;
}
...
proccall_astnode::proccall_astnode(ref_astnode* c1,vector<exp_astnode*>c2,string rcode){
    this->child1 = c1;
    this->child2 = c2;
    this->rcode = rcode;
}

proccall_astnode::proccall_astnode(ref_astnode* c1,string rcode){
    this->child1 = c1;
    this->rcode = rcode;
}
...
if_astnode::if_astnode(exp_astnode *c1, statement_astnode *c2, statement_astnode *c3,string rcode){
    this->child1 = c1;
    this->child2 = c2;
    this->child3 = c3;
    this->rcode = rcode;
...
while_astnode::while_astnode(exp_astnode *c1, statement_astnode *c2,string rcode){
    this->child1 = c1;
    this->child2 = c2;
    this->rcode = rcode;
}
...
for_astnode::for_astnode(exp_astnode *c1,exp_astnode *c2,exp_astnode *c3,statement_astnode *c4,string rcode){
    this->child1 = c1;
    this->child2 = c2;
    this->child3 = c3;
    this->child4 = c4;
...
op_binary_astnode::op_binary_astnode(string c1,exp_astnode *c2,exp_astnode *c3,string typeVal,string code){
    this->child1 = c1;
    this->child2 = c2;
    this->child3 = c3;
    this->typeExp = typeVal;
...
op_unary_astnode::op_unary_astnode(string c1,exp_astnode *c2,string typeVal,string rcode){
    this->child1 = c1;
    this->child2 = c2;
    this->typeExp = typeVal;
    if(rcode!="")
...
assignE_exp::assignE_exp(exp_astnode *c1,exp_astnode *c2,string typeVal,string rcode){
    this->child1 = c1;
    this->child2 = c2;
    this->typeExp = typeVal;
    this->rcode = rcode;
...
funcall_astnode::funcall_astnode(ref_astnode *c1,string typeVal,string rcode){
    this->child1 = c1;
    this->typeExp = typeVal;
    this->rcode = rcode;
}   

funcall_astnode::funcall_astnode(ref_astnode *c1,vector<exp_astnode*> c2,string typeVal,string rcode){
    this->child1 = c1;
    this->child2 = c2;
    this->typeExp = typeVal;
    this->rcode = rcode;
...
intconst_astnode::intconst_astnode(int c1,string code){
    this->child1 = c1;
    this->typeExp = "int";
    this->rcode = code;
    // cout<<code<<"\n";
...
identifier_astnode::identifier_astnode(string c1,string typeVal,string code,string lloc){
    this->child1 = c1;
    this->typeExp = typeVal;
    this->rcode  = code;
    this->lloc = lloc;
...
identifier_astnode::identifier_astnode(string c1,string typeVal,string code,string lloc,int offset){
    this->child1 = c1;
    this->typeExp = typeVal;
    this->rcode  = code;
    this->lloc = lloc;
...
member_astnode::member_astnode(exp_astnode *c1,identifier_astnode *c2,string typeVal,string rcode,string lloc,int offset){
    this->child1 = c1;
    this->child2 = c2;
    this->typeExp = typeVal;
    this->rcode = rcode;
