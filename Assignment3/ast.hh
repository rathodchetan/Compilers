...
class seq_astnode : public statement_astnode
{
    ...
    seq_astnode(){};
    seq_astnode(vector<statement_astnode*> c1,string rcode);
    seq_astnode(string rcode){this->rcode=rcode;};
    void print(int blank);
}; 
...
class assignS_astnode : public statement_astnode
{
    protected:
        ...
        exp_astnode *child2;
    public:
    assignS_astnode(exp_astnode *c1,exp_astnode *c2,string rcode);
    void print(int blank);
}; 
...
class return_expnode : public statement_astnode
{
    protected:
        exp_astnode *child1;
    public:
    return_expnode(exp_astnode *c1,string rcode);
    void print(int blank);
};
...
class proccall_astnode : public statement_astnode
{
    ...
    public:
    proccall_astnode(ref_astnode* c1,vector<exp_astnode*>c2,string rcode);
    proccall_astnode(ref_astnode* c1,string rcode);
    void print(int blank);
};
...
class if_astnode : public statement_astnode
{
    ...
    public:
    if_astnode(exp_astnode *c1, statement_astnode *c2, statement_astnode *c3,string rcode);
    void print(int blank);
};
...
class while_astnode : public statement_astnode
{
    protected:
        ...
        statement_astnode *child2;
    public:
    while_astnode(exp_astnode *c1, statement_astnode *c2,string rcode);
    void print(int blank);
};
...
class for_astnode : public statement_astnode
{
    ...
    public:
    for_astnode(exp_astnode *c1,exp_astnode *c2,exp_astnode *c3,statement_astnode *c4,string rcode);
    void print(int blank);
};
...
class op_binary_astnode : public exp_astnode
{
    ...
    public:
        ...
        op_binary_astnode(string c1,exp_astnode *c2,exp_astnode *c3,string typeVal,string code);
        void print(int blank);
};
...
class op_unary_astnode : public exp_astnode
{
    ...
    public:
        ...
        op_unary_astnode(string c1,exp_astnode *c2,string typeVal,string rcode);
        void print(int blank);
};
...
class assignE_exp : public exp_astnode
{
    protected:
        ...
        exp_astnode *child2;
    public:
        assignE_exp(exp_astnode *c1,exp_astnode *c2,string typeVal,string rcode);
        void print(int blank);
...
class funcall_astnode : public exp_astnode
{
    ...
    public:
        ...
        funcall_astnode(ref_astnode *c1,string typeVal,string rcode);
        funcall_astnode(ref_astnode *c1,vector<exp_astnode*> c2,string typeVal,string rcode);
        void print(int blank);
};
...
class intconst_astnode : public exp_astnode
{
    ...
    public:
        intconst_astnode(int c1,string code);
        void print(int blank);
};
...
class identifier_astnode : public ref_astnode
{
    protected:
        string child1;
    public:
        identifier_astnode(string c1,string typeVal,string code,string rloc);
        identifier_astnode(string c1,string typeVal,string code,string rloc,int offset);
        void print(int blank);
        string getChild();
};
...
class member_astnode : public ref_astnode
{
    ...
    public:
        member_astnode(exp_astnode *c1,identifier_astnode *c2,string typeVal,string rcode,string lloc,int offset);
        void print(int blank);
};
